...
public class OKMDocumentService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("[Lcom.openkm.frontend.client.bean.GWTVersion;/1361711140", new com.openkm.frontend.client.bean.GWTVersion_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("[Ljava.util.AbstractMap;/793369879", new com.google.gwt.user.client.rpc.core.java.util.AbstractMap_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("[Ljava.util.HashMap;/3177835830", new com.google.gwt.user.client.rpc.core.java.util.HashMap_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("[Ljava.util.IdentityHashMap;/2474540338", new com.google.gwt.user.client.rpc.core.java.util.IdentityHashMap_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("[Ljava.util.LinkedHashMap;/1938953787", new com.google.gwt.user.client.rpc.core.java.util.LinkedHashMap_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("[Ljava.util.Map;/1931242982", new com.google.gwt.user.client.rpc.core.java.util.Map_Array_Rank_1_FieldSerializer.Handler());
    result.put("[Ljava.util.SortedMap;/4128485282", new com.google.gwt.user.client.rpc.core.java.util.SortedMap_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("[Ljava.util.TreeMap;/121515164", new com.google.gwt.user.client.rpc.core.java.util.TreeMap_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["[Lcom.openkm.frontend.client.bean.GWTVersion;/1361711140"] = [
    ...
    result["[Ljava.util.HashMap;/3177835830"] = [
        ,
        ,
    ...
    result["[Ljava.util.IdentityHashMap;/2474540338"] = [
        ,
        ,
    ...
    result["[Ljava.util.LinkedHashMap;/1938953787"] = [
        ,
        ,
    ...
    result["[Ljava.util.TreeMap;/121515164"] = [
        ,
        ,
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTVersion_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTVersion;/1361711140");
    ...
    result.put(com.google.gwt.user.client.rpc.core.java.util.AbstractMap_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.AbstractMap;/793369879");
    ...
    result.put(com.google.gwt.user.client.rpc.core.java.util.HashMap_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.HashMap;/3177835830");
    ...
    result.put(com.google.gwt.user.client.rpc.core.java.util.IdentityHashMap_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.IdentityHashMap;/2474540338");
    ...
    result.put(com.google.gwt.user.client.rpc.core.java.util.LinkedHashMap_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.LinkedHashMap;/1938953787");
    ...
    result.put(com.google.gwt.user.client.rpc.core.java.util.Map_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.Map;/1931242982");
    result.put(com.google.gwt.user.client.rpc.core.java.util.SortedMap_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.SortedMap;/4128485282");
    ...
    result.put(com.google.gwt.user.client.rpc.core.java.util.TreeMap_Array_Rank_1_FieldSerializer.concreteType(), "[Ljava.util.TreeMap;/121515164");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTVersion[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTVersion;/1361711140";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@java.util.HashMap[]::class)] = "[Ljava.util.HashMap;/3177835830";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@java.util.IdentityHashMap[]::class)] = "[Ljava.util.IdentityHashMap;/2474540338";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@java.util.LinkedHashMap[]::class)] = "[Ljava.util.LinkedHashMap;/1938953787";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@java.util.TreeMap[]::class)] = "[Ljava.util.TreeMap;/121515164";
