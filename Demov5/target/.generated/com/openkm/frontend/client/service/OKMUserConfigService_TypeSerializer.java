...
public class OKMUserConfigService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("com.openkm.frontend.client.bean.GWTUserConfig/281041504", new com.openkm.frontend.client.bean.GWTUserConfig_FieldSerializer.Handler());
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTUserConfig/281041504"] = [
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTUserConfig_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTUserConfig/281041504");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTUserConfig::class)] = "com.openkm.frontend.client.bean.GWTUserConfig/281041504";
