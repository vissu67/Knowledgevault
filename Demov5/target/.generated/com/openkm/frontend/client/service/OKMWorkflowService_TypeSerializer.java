...
public class OKMWorkflowService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("com.openkm.frontend.client.bean.GWTComment/1863034966", new com.openkm.frontend.client.bean.GWTComment_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTComment;/1309581552", new com.openkm.frontend.client.bean.GWTComment_Array_Rank_1_FieldSerializer.Handler());
    ...
    result.put("com.openkm.frontend.client.bean.GWTProcessDefinition/293184377", new com.openkm.frontend.client.bean.GWTProcessDefinition_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTProcessDefinition;/3684141702", new com.openkm.frontend.client.bean.GWTProcessDefinition_Array_Rank_1_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTProcessInstance/855740939", new com.openkm.frontend.client.bean.GWTProcessInstance_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTTaskInstance/1180061870", new com.openkm.frontend.client.bean.GWTTaskInstance_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTTaskInstance;/3168556360", new com.openkm.frontend.client.bean.GWTTaskInstance_Array_Rank_1_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTToken/2740453662", new com.openkm.frontend.client.bean.GWTToken_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTTransition/2459644146", new com.openkm.frontend.client.bean.GWTTransition_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTTransition;/3946591445", new com.openkm.frontend.client.bean.GWTTransition_Array_Rank_1_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTWorkflowComment/4159241623", new com.openkm.frontend.client.bean.GWTWorkflowComment_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTWorkflowComment;/1260915318", new com.openkm.frontend.client.bean.GWTWorkflowComment_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTProcessInstance/855740939"] = [
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTComment_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTComment/1863034966");
    result.put(com.openkm.frontend.client.bean.GWTComment_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTComment;/1309581552");
    ...
    result.put(com.openkm.frontend.client.bean.GWTProcessDefinition_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTProcessDefinition/293184377");
    result.put(com.openkm.frontend.client.bean.GWTProcessDefinition_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTProcessDefinition;/3684141702");
    result.put(com.openkm.frontend.client.bean.GWTProcessInstance_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTProcessInstance/855740939");
    result.put(com.openkm.frontend.client.bean.GWTTaskInstance_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTTaskInstance/1180061870");
    result.put(com.openkm.frontend.client.bean.GWTTaskInstance_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTTaskInstance;/3168556360");
    result.put(com.openkm.frontend.client.bean.GWTToken_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTToken/2740453662");
    result.put(com.openkm.frontend.client.bean.GWTTransition_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTTransition/2459644146");
    result.put(com.openkm.frontend.client.bean.GWTTransition_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTTransition;/3946591445");
    result.put(com.openkm.frontend.client.bean.GWTWorkflowComment_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTWorkflowComment/4159241623");
    result.put(com.openkm.frontend.client.bean.GWTWorkflowComment_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTWorkflowComment;/1260915318");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTProcessInstance::class)] = "com.openkm.frontend.client.bean.GWTProcessInstance/855740939";
