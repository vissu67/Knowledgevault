...
public class OKMKeyValueService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("com.openkm.frontend.client.bean.GWTKeyValue/1621849594", new com.openkm.frontend.client.bean.GWTKeyValue_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTKeyValue;/1205251713", new com.openkm.frontend.client.bean.GWTKeyValue_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTKeyValue_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTKeyValue/1621849594");
    result.put(com.openkm.frontend.client.bean.GWTKeyValue_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTKeyValue;/1205251713");
