...
public class OKMBookmarkService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("com.openkm.frontend.client.bean.GWTBookmark/969162629", new com.openkm.frontend.client.bean.GWTBookmark_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTBookmark;/2702109913", new com.openkm.frontend.client.bean.GWTBookmark_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTBookmark_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTBookmark/969162629");
    result.put(com.openkm.frontend.client.bean.GWTBookmark_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTBookmark;/2702109913");
