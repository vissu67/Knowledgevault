...
public class OKMGeneralService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("com.openkm.frontend.client.bean.GWTFileUploadingStatus/1992330392", new com.openkm.frontend.client.bean.GWTFileUploadingStatus_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTTestImap/4119643962", new com.openkm.frontend.client.bean.GWTTestImap_FieldSerializer.Handler());
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTTestImap/4119643962"] = [
        @com.openkm.frontend.client.bean.GWTTestImap_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTTestImap_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTTestImap;),
      ];
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTFileUploadingStatus_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTFileUploadingStatus/1992330392");
    result.put(com.openkm.frontend.client.bean.GWTTestImap_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTTestImap/4119643962");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTTestImap::class)] = "com.openkm.frontend.client.bean.GWTTestImap/4119643962";
