...
public class OKMDashboardService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("com.openkm.frontend.client.bean.GWTDashboardDocumentResult/1650384741", new com.openkm.frontend.client.bean.GWTDashboardDocumentResult_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTDashboardDocumentResult;/1369320834", new com.openkm.frontend.client.bean.GWTDashboardDocumentResult_Array_Rank_1_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTDashboardFolderResult/2622075398", new com.openkm.frontend.client.bean.GWTDashboardFolderResult_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTDashboardFolderResult;/2294099244", new com.openkm.frontend.client.bean.GWTDashboardFolderResult_Array_Rank_1_FieldSerializer.Handler());
    result.put("com.openkm.frontend.client.bean.GWTDashboardMailResult/3862903639", new com.openkm.frontend.client.bean.GWTDashboardMailResult_FieldSerializer.Handler());
    result.put("[Lcom.openkm.frontend.client.bean.GWTDashboardMailResult;/3513573383", new com.openkm.frontend.client.bean.GWTDashboardMailResult_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.openkm.frontend.client.bean.GWTDashboardDocumentResult_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTDashboardDocumentResult/1650384741");
    result.put(com.openkm.frontend.client.bean.GWTDashboardDocumentResult_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTDashboardDocumentResult;/1369320834");
    result.put(com.openkm.frontend.client.bean.GWTDashboardFolderResult_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTDashboardFolderResult/2622075398");
    result.put(com.openkm.frontend.client.bean.GWTDashboardFolderResult_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTDashboardFolderResult;/2294099244");
    result.put(com.openkm.frontend.client.bean.GWTDashboardMailResult_FieldSerializer.concreteType(), "com.openkm.frontend.client.bean.GWTDashboardMailResult/3862903639");
    result.put(com.openkm.frontend.client.bean.GWTDashboardMailResult_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.openkm.frontend.client.bean.GWTDashboardMailResult;/3513573383");
